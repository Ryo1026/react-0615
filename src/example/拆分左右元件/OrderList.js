      ...
      <div className="col-md-8 cart">
        ...
        <div className="row border-top border-bottom">
          <div className="row main align-items-center">
            ...
            <div className="col">
              <div className="row text-muted">短T</div>
            ...
            <div className="col">
              <a
                href="#/"
                onClick={() => {
                  const newTshirtOne = tshirtOne - 1 < 1 ? 1 : tshirtOne - 1
          ...
          <div className="row main align-items-center">
            ...
            <div className="col">
              <a
                href="#/"
                onClick={() => {
                  const newTshirtTwo = tshirtTwo - 1 < 1 ? 1 : tshirtTwo - 1
              ...
              <a
                ...
                onClick={() => {
                  const newTshirtThree =
                    tshirtThree - 1 < 1 ? 1 : tshirtThree - 1
